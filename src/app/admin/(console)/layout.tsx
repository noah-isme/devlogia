...
export default async function AdminLayout({ children }: AdminLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto flex w-full max-w-[96rem] flex-col gap-6 px-4 pb-12 pt-6 sm:px-6 lg:flex-row lg:px-8">
        ...
        <main
          id="main-content"
          className="premium-surface flex-1 rounded-3xl p-4 sm:p-6 lg:p-9"
        >
          {maintenanceMode && (
          ...
          <header className="mb-8 flex flex-col gap-4 border-b border-border/60 pb-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Use the navigation to jump between admin tools. Keyboard users
                can press Tab to skip straight to the content area.
              </p>
            </div>
          </header>
