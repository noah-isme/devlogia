...
> Historical release note. The current v1.0.1 development line uses MySQL 8 and the commands documented in the root README; provider details below are retained as release history.
