...
> Historical phase record. References to a PostgreSQL Playwright service and Playwright 1.47 describe the phase at that time; the current repository uses MySQL 8 and Playwright 1.56.1.
